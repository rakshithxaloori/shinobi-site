...
const PrivacyPolicy = () => (
  <div className="privacy-policy">
    ...
    <p>
      Shinobi built the Shinobu app as a Freemium app. This SERVICE is provided
      by Shinobi at no cost and is intended for use as is.
    </p>{" "}
    <p>
    ...
    <p>
      ...
      not limited to email address. The information that we request will be
