...
const Terms = () => (
  <div className="terms">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Shinobi.
    </p>{" "}
    <p>
    ...
    <p>
      The Shinobu app stores and processes personal data that you have provided
      ...
      features and it could mean that the Shinobu app won’t work properly or at
      all.
    </p>{" "}
    <div>
      <p>
    ...
    <p>
      ...
      provided by your mobile network provider, but Shinobi cannot take
    ...
    <p>
      ...
      Service, Shinobi cannot accept responsibility.
    </p>{" "}
    <p>
      With respect to Shinobi’s responsibility for your use of the app, when
      ...
      available to you. Shinobi accepts no liability for any loss, direct or
    ...
    <p>
      ...
      using the app. Shinobi does not promise that it will always update the app
