  ...
  <div className="terms">
    <body className="Text-body">
      ...
      <p>
        ...
        the Service, Shinobi cannot accept responsibility.
      </p>{" "}
      <p>
        ...
        it available to you. Shinobi accepts no liability for any loss, direct
      ...
      <p>
        ...
        to keep using the app. Shinobi does not promise that it will always
